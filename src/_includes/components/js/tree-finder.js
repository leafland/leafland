  ...
  if (treeDataSubset.length === 0) {
    ...
    for (let i = 0; i < treeDataSubset.length; i++) {
      if (!(treeDataSubset[i] === undefined || treeDataSubset[i] === null)) {
        ...
        treeTitle.innerHTML = `${treeDataSubset[i].fullName}`;
        ...
        treeImage.src = `https://img.imageboss.me/leafland/width/150/quality:75,format:auto/${treeDataSubset[i].url}/${treeDataSubset[i].url}${treeDataSubset[i].images[0]}.jpg`;
        treeImage.width = "150";
