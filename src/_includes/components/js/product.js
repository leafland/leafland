...
async function createStockValues() {
  ...
  if (stockData.length > 0) {
    ...
    //         document.querySelector("#order-grades-table-inner").innerHTML = "";
    //         document
    //           .querySelector("#order-grades-table")
    ...
    //               for (let k = 0; k < stockData[j].length; k++) {
    //                 if (k !== 0 && k !== 1 && k !== 4 && k < 9) {
    //                   let cell = document.createElement("td");
    //                   if (stockListType === "retail") {
    //                     if (k !== 5) {
    //                       cell.textContent = stockData[j][k].replaceAll(
    //                         '"',
    //                         ""
    //                       );
