  ...
  submitOrderTrees.forEach((tree) => {
    ...
    (treeImage.src = `https://leafland.imgix.net/images/trees/${tree.mainImage}?auto=format&w=300&q=75`),
      ...
      "Pickup" !== region.value
        ...
        : ((freightPrice.innerHTML =
            '<p>Freight per tree: <span class="accent-color">N/A</span></p>'),
          (treesField.value += `<tr style="padding-bottom:3px;margin-bottom:3px;border-bottom:2px solid #000"><td><b>${
            tree.botanicalName
          } (${tree.commonName})</b></td> <td><b>${
            tree.grade
    ...
    "Pickup" !== region.value
      ...
      : ((freightTotal.innerHTML =
          'Freight Total: <span class="accent-color">N/A</span>'),
...
(total = loggedIn ? totalWholesaleCost : totalRetailCost),
  ...
  document
    .querySelector("#close-submit-order")
